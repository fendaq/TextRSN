...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--threshold', default=0.3, type=float, help='start epoch number')
        self.parser.add_argument('--score_i', default=0.65, type=float, help='filter the socre < score_i')
        # demo args
